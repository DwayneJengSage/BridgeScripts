...
public class ParkinsonWeeklySurvey {
    ...
    public static Survey create() {
        ...
        mvc.setEnumeration(Lists.newArrayList(new SurveyQuestionOption("Often"), new SurveyQuestionOption("Sometimes"),
                new SurveyQuestionOption("Never/Rarely")));
        leisure.setUiHint(UiHint.RADIOBUTTON);
        leisure.setConstraints(mvc);

        SurveyQuestion memory = listQuestion(
                "memory",
        ...
        SurveyQuestion emotions = listQuestion(
                "emotions",
        ...
        SurveyQuestion anxiety = listQuestion(
                "anxiety",
        ...
        SurveyQuestion socialActivities = listQuestion(
                "social-activities",
        ...
        SurveyQuestion sleeping = listQuestion(
                "sleeping",
        ...
        SurveyQuestion wakefulness = listQuestion(
                "wakefulness",
        ...
        SurveyQuestion speech = listQuestion(
                "speech",
        ...
        SurveyQuestion eating = listQuestion(
                "eating",
        ...
        SurveyQuestion dressing = listQuestion(
                "dressing",
                ...
                "Normal: Not at all (no problems).", "Slight: I am slow but I do not need help.",
                "Mild: I am slow and need help for a few dressing tasks (buttons, bracelets).",
                "Moderate: I need help for many dressing tasks.", "Severe: I need help for most or all dressing tasks.");

        SurveyQuestion washing = listQuestion(
                "washing",
                ...
                "Normal: Not at all (no problems).", "Slight: I am slow but I do not need any help.",
        ...
        SurveyQuestion handwriting = listQuestion("handwriting",
                ...
                "Moderate: Many words are unclear and difficult to read.", "Severe: Most or all words cannot be read.");

        SurveyQuestion hobbies = listQuestion(
                "hobbies",
                "Over the past week, have you usually had trouble doing your hobbies or other things that you like to do?",
                "Normal: Not at all (no problems).", "Slight: I am a bit slow but do these activities easily.",
        ...
        SurveyQuestion turningOverInBed = listQuestion("turning-over-in-bed",
        ...
        SurveyQuestion balance = listQuestion(
                "balance",
        ...
        SurveyQuestion walking = listQuestion(
                "walking",
        ...
        elements.add(feeling);
        elements.add(strenuousExersize);
        elements.add(moderateExersize);
        elements.add(mildExersize);
        elements.add(leisure);
        elements.add(memory);
        elements.add(emotions);
        elements.add(tableQuestion("7-day-workthless", "In the past 7 days, I felt worthless"));
        elements.add(tableQuestion("7-day-helpless", "In the past 7 days, I felt helpless"));
        elements.add(tableQuestion("7-day-depressed", "In the past 7 days, I felt depressed"));
        elements.add(tableQuestion("7-day-hopeless", "In the past 7 days, I felt hopeless"));
        elements.add(tableQuestion("7-day-failure", "In the past 7 days, I felt like a failure"));
        elements.add(tableQuestion("7-day-unhappy", "In the past 7 days, I felt unhappy"));
        elements.add(tableQuestion("7-day-nothing-to-look-forward-to",
                "In the past 7 days, I felt that I had nothing to look forward to"));
        elements.add(tableQuestion("7-day-nothing-to-cheer-me-up",
                "In the past 7 days, I felt that nothing could cheer me up"));
        elements.add(anxiety);
        elements.add(socialActivities);
        elements.add(sleeping);
        elements.add(wakefulness);
        elements.add(speech);
        elements.add(eating);
        elements.add(dressing);
        elements.add(washing);
        elements.add(handwriting);
        elements.add(hobbies);
        elements.add(turningOverInBed);
        elements.add(tremors);
        elements.add(balance);
        elements.add(walking);
    ...
    private static SurveyQuestion listQuestion(String identifier, String prompt, String... options) {
        ...
        c.setEnumeration(Lists.newArrayList(new SurveyQuestionOption(options[0], "0"), new SurveyQuestionOption(
                options[1], "1"), new SurveyQuestionOption(options[2], "2"), new SurveyQuestionOption(options[3], "3"),
    ...
    {
        tableConstraints.setEnumeration(Lists.newArrayList(new SurveyQuestionOption("Never"), new SurveyQuestionOption(
                "Rarely"), new SurveyQuestionOption("Sometimes"), new SurveyQuestionOption("Often"),
