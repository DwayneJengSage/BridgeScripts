...
public class ParkinsonWeeklySurvey {

    static SurveyQuestion feeling = new SurveyQuestion(); 
    {
    ...
    static SurveyQuestion strenuousExersize = new SurveyQuestion(); 
    {
    ...
    static SurveyQuestion moderateExersize = new SurveyQuestion(); 
    {
    ...
    static SurveyQuestion mildExersize = new SurveyQuestion(); 
    {
    ...
    static SurveyQuestion leisure = new SurveyQuestion(); 
    {
    ...
    static SurveyQuestion memory = listQuestion("memory", "Over the past week have you had problems remembering things, following conversations, paying attention, thinking clearly, or finding your way around the house or in town?",
    ...
    static SurveyQuestion emotions = listQuestion("emotions", "Over the past week have you felt low, sad, hopeless or unable to enjoy things?",
    ...
    static SurveyQuestion anxiety = listQuestion("anxiety", "Over the past week have you felt nervous, worried or tense?",
    ...
    static SurveyQuestion socialActivities = listQuestion("social-activities", "Over the past week, have you felt indifferent to doing activities or being with people?",
            "Normal: No apathy.",
    ...
    static SurveyQuestion sleeping = listQuestion("sleeping", "Over the past week, have you had trouble going to sleep at night or staying asleep through the night? Consider how rested you felt after waking up in the morning?", 
            "Normal: No problems.", 
    ...
    static SurveyQuestion wakefulness = listQuestion("wakefulness", "Over the past week, have you had trouble staying awake during the daytime?", 
    ...
    static SurveyQuestion speech = listQuestion("speech", "Over the past week, have you had problems with your speech?",
    ...
    static SurveyQuestion eating = listQuestion("eating", "Over the past week, have you usually had troubles handling your food and using eating utensils? For example, do you have trouble handling finger foods or using forks, knifes, spoons, chopsticks?",
            "Normal: Not at all (No problems).", 
    ...
    static SurveyQuestion dressing = listQuestion("dressing", "Over the past week, have you usually had problems dressing? For example, are you slow or do you need help with buttoning, using zippers, putting on or taking off your clothes or jewelry?",
            "Normal: Not at all (no problems).", 
    ...
    static SurveyQuestion washing = listQuestion("washing", "Over the past week, have you usually been slow or do you need help with washing, bathing, shaving, brushing teeth, combing your hair or with other personal hygiene?", 
            "Normal: Not at all (no problems).", 
    ...
    static SurveyQuestion handwriting = listQuestion("handwriting", "Over the past week, have people usually had trouble reading your handwriting?",
            "Normal: Not at all (no problems).",
    ...
    static SurveyQuestion hobbies = listQuestion("hobbies", "Over the past week, have you usually had trouble doing your hobbies or other things that you like to do?", 
            "Normal: Not at all (no problems).", 
    ...
    static SurveyQuestion turningOverInBed = listQuestion("turning-over-in-bed", "Over the past week, do you usually have trouble turning over in bed?", 
            "Normal: Not at all (no problems).",
    ...
    static SurveyQuestion tremors = listQuestion("tremors", "Over the past week, have you usually had shaking or tremor?",
    ...
    static SurveyQuestion balance = listQuestion("balance", "Over the past week, have you usually had problems with balance and walking?", 
            "Normal: Not at all (no problems).",
    ...
    static SurveyQuestion walking = listQuestion("walking", "Over the past week, on your usual day when walking, do you suddenly stop or freeze as if your feet are stuck to the floor.",
            "Normal: Not at all (no problems).",
    ...
    private static SurveyQuestion listQuestion(String identifier, String prompt, String... options) {
    ...
    private static MultiValueConstraints tableConstraints = new MultiValueConstraints(DataType.STRING);
    {
    ...
    private static SurveyQuestion tableQuestion(String identifier, String prompt) {
        SurveyQuestion q = new SurveyQuestion();
        q.setIdentifier(identifier);
        q.setPrompt(prompt);
        q.setUiHint(UiHint.RADIOBUTTON);
    ...
    public static Survey create() {
        ...
        survey.setName("Parkinson Weekly Survey");
        survey.setIdentifier("parkinson-weekly");
        
        survey.getElements().add(feeling);
        survey.getElements().add(strenuousExersize);
        survey.getElements().add(moderateExersize);
        survey.getElements().add(mildExersize);
        survey.getElements().add(leisure);
        survey.getElements().add(memory);
        survey.getElements().add(emotions);
        survey.getElements().add(tableQuestion("7-day-workthless", "In the past 7 days, I felt worthless"));
        survey.getElements().add(tableQuestion("7-day-helpless", "In the past 7 days, I felt helpless"));
        survey.getElements().add(tableQuestion("7-day-depressed", "In the past 7 days, I felt depressed"));
        survey.getElements().add(tableQuestion("7-day-hopeless", "In the past 7 days, I felt hopeless"));
        survey.getElements().add(tableQuestion("7-day-failure", "In the past 7 days, I felt like a failure"));
        survey.getElements().add(tableQuestion("7-day-unhappy", "In the past 7 days, I felt unhappy"));
        survey.getElements().add(tableQuestion("7-day-nothing-to-look-forward-to", "In the past 7 days, I felt that I had nothing to look forward to"));
        survey.getElements().add(tableQuestion("7-day-nothing-to-cheer-me-up", "In the past 7 days, I felt that nothing could cheer me up"));
        survey.getElements().add(anxiety);
        survey.getElements().add(socialActivities);
        survey.getElements().add(sleeping);
        survey.getElements().add(wakefulness);
        survey.getElements().add(speech);
        survey.getElements().add(eating);
        survey.getElements().add(dressing);
        survey.getElements().add(washing);
        survey.getElements().add(handwriting);
        survey.getElements().add(hobbies);
        survey.getElements().add(turningOverInBed);
        survey.getElements().add(tremors);
        survey.getElements().add(balance);
        survey.getElements().add(walking);
        return survey;
    }
