...
public class ExerciseReadinessSurvey implements SurveyProvider {
    ...
    public Survey createSurvey() {
        List<SurveyRule> EMPTY_RULES = Lists.<SurveyRule>newArrayList();
        
        Survey survey = new Survey();
        survey.setName(NAME);
        survey.setIdentifier("par-q quiz");
        return new SurveyBuilder(survey)
            ...
            .radio("chestPain", "Do you feel pain in your chest when you do physical activity?", false, DataType.BOOLEAN, new YesNoList(), EMPTY_RULES)
            .radio("chestPainInLastMonth", "In the past month, have you had chest pain when you were not doing physical activity?", false, DataType.BOOLEAN, new YesNoList(), EMPTY_RULES)
            .radio("dizziness", "Do you lose your balance because of dizziness or do you ever lose consciousness?", false, DataType.BOOLEAN, new YesNoList(), EMPTY_RULES)
            .radio("jointProblem", "Do you have a bone or joint problem (for example, back, knee or hip) that could be made worse by a change in your physical activity?", false, DataType.BOOLEAN, new YesNoList(), EMPTY_RULES)
            .radio("prescriptionDrugs", "Is your doctor currently prescribing drugs (for example, water pills) for your blood pressure or heart condition?", false, DataType.BOOLEAN, new YesNoList(), EMPTY_RULES)
            .radio("physicallyCapable", "Do you know of any other reason why you should not do physical activity?", false, DataType.BOOLEAN, new YesNoList(), EMPTY_RULES)
